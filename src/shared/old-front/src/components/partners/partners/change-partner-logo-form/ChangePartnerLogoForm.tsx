...
import c from './ChangePartnerLogoForm.module.scss'
...
const ChangePartnerLogoForm: React.FC<Props> = ({ id, onClose }) => {
	...
	const mutation = useMutation({
		mutationFn: partnersApi.updateLogo,
		onSuccess: () => {
...
export default ChangePartnerLogoForm
